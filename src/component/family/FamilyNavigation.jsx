    ...
    <div className="fam-layout">
      ...
      <aside className={`fam-sidebar${collapsed ? " collapsed" : ""}${mobileOpen ? " mobile-open" : ""}`}>
        ...
        <div className="fam-brand">
          <div className="fam-brand-icon" title="Cherubim of Heaven" style={{ background: "transparent", boxShadow: "none" }}><img src={logoIcon} alt="Logo" style={{ width: "100%", height: "100%", objectFit: "contain", transform: "scale(1.2)" }} /></div>
